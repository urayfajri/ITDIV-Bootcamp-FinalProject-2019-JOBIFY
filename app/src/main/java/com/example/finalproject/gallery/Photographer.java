...
public class Photographer extends Fragment {

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.gallery_photographer, container, false);
        ...
        llShowLess= view.findViewById(R.id.ll_show_less_photo);
        llShowMore= view.findViewById(R.id.ll_show_more_photo);
    ...
    public void onResume(){
        super.onResume();
        ((MainActivity) getActivity()).getSupportActionBar().setTitle("Photographer");
