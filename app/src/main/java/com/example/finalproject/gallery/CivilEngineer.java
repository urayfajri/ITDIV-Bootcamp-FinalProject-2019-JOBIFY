...
public class CivilEngineer extends Fragment {

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.gallery_civil_engineering, container, false);
        ...
        llShowLess= view.findViewById(R.id.ll_show_less_civil);
        llShowMore= view.findViewById(R.id.ll_show_more_civil);
    ...
    public void onResume(){
        ...
        ((MainActivity) getActivity()).getSupportActionBar().setTitle("Civil Engineer");
    }
}
